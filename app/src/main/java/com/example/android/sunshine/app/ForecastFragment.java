...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        final String LOG_TAG = Thread.currentThread().getStackTrace()[2].getMethodName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // And convert it into an ArrayList
        ...
        ArrayAdapter<String> forecastAdapter = new ArrayAdapter<>(
                ...
                forecastArray); // Array or ArrayList of Strings to represent the ListView
    ...
    public class FetchWeatherTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            Log.d(LOG_TAG, "Running Background Thread");
            ...
            try {
                ...
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=92694&mode=json&units=metric&cnt=7");
